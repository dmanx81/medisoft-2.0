...
void test('migrations 001 through 010 apply in order on an empty engine', async () => {
 ...
 AND relname IN ('organizations','patients','lab_orders','lab_results','lab_reports','lab_invoices','lab_invoice_payment_reversals','lab_credit_notes','doctors','prescriptions')
 ORDER BY relname`,
    );
