...
Phase 2 implements the previously proposed Patient CRM scope. Phase 3 implements the laboratory test catalogue and versioned reference ranges; see [lab-catalogue.md](lab-catalogue.md). Phase 4 implements laboratory orders and specimens; see [lab-orders-specimens.md](lab-orders-specimens.md). Phase 5 implements results, technical validation, clinical verification and amendments; see [lab-results.md](lab-results.md). Reports and AI remain deferred.
